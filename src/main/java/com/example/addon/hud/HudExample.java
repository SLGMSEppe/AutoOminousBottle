...
import com.example.addon.SeppeAutoBottleAddon;
...
public class HudExample extends HudElement {
    ...
    public void render(HudRenderer renderer) {
        setSize(renderer.textWidth("AutoOminousBottle", true), renderer.textHeight(true));

        // Render background
        renderer.quad(x, y, getWidth(), getHeight(), Color.LIGHT_GRAY);

        // Render text
        renderer.text("AutoOminousBottle", x, y, Color.WHITE, true);
    }
}
